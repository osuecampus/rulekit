...
The project should have `scripts/get-pr-comments.sh` which retrieves all three comment types:
...
| Need                         | Tool/Command                                           |
| ---------------------------- | ------------------------------------------------------ |
| All PR comments at once      | `./scripts/get-pr-comments.sh {PR}`                    |
...
1. Run: ./scripts/get-pr-comments.sh 13
2. Parse results:
